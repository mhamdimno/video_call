...
class MeetingActionBar extends StatelessWidget {
  // control states
  final bool isMicEnabled, isCamEnabled, isScreenShareEnabled,isBackCamera;
  ...
  final void Function() onCallEndButtonPressed,
      ...
      onMicButtonPressed,
      onCameraButtonPressed,onChangeCameraButtonPressed;
  ...
  const MeetingActionBar({
    ...
    required this.onChangeCameraButtonPressed,
